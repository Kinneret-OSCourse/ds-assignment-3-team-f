...
if "%~1"=="" (
    echo Usage: run-customer.bat ^<server-pc-ip^>
    echo Example: run-customer.bat 192.168.1.25
    exit /b 1
)
...
set "MULLIGAN_QUEUE_USER_CUSTOMER=mulligan_customer"
set "MULLIGAN_QUEUE_PASSWORD_CUSTOMER=customer159357"
if "%MULLIGAN_HMAC_KEY%"=="" (
    set "MULLIGAN_HMAC_KEY=0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"
)

pushd "%~dp0"
call gradlew.bat :parking-system-CustomerUI:run --no-daemon
