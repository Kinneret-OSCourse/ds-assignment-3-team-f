...
/**
 * Provides JDBC connections for the MO module against the 3-node Patroni
 * Postgres cluster.
 *
 * <p>The cluster-aware URL construction lives in
 * {@link PostgresClusterConnection} (shared with the Customer and PEO
 * modules). This class only guarantees the MO-specific reporting tables exist
 * on first use.
 *
...
public final class DatabaseConnection {
    ...
    private static final PostgresClusterConnection CLUSTER = new PostgresClusterConnection(new SecureLogger("mo-db"));
