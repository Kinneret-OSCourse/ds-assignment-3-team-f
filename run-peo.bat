...
if "%~1"=="" (
    echo Usage: run-peo.bat ^<server-pc-ip^>
    echo Example: run-peo.bat 192.168.1.25
    exit /b 1
)
...
set "MULLIGAN_QUEUE_USER_PEO=mulligan_peo"
set "MULLIGAN_QUEUE_PASSWORD_PEO=peo159357"
if "%MULLIGAN_HMAC_KEY%"=="" (
    set "MULLIGAN_HMAC_KEY=0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"
)

pushd "%~dp0"
call gradlew.bat :parking-system-PEOUI:run --no-daemon
